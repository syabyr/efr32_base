 ...
 */
#define handleCommandClassDoorLock(a, b, c)                CC_DoorLock_handler(a, b, c)
 ...
 * @return Returns whether the command was successfully parsed, failed to be parsed or is not
 * supported.
 */
