...
/**
* Forward declartion of SSwTimer to allow SSwTimer to contain
* a callback function pointer with its own type a Argument
*/
typedef struct SSwTimer SSwTimer;  // forward declaration

/**
* Timer object. All content is private.
*/
typedef struct SSwTimer
{
  StaticTimer_t xTimer;                 /**< FreeRTOS timer object */
  void(* pCallback)(SSwTimer* pTimer);  /**< Callback function pointer */
