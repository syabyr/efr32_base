...
// Note that this structure must fit in 32 bytes, to allow efficient
// storage of the transient key table in a queue of buffers.
typedef struct {
  EmberEUI64 eui64;
 ...
 * as stored in ram variable parentNwkInformation and basic token at PARENT_ADDITIONAL_INFO.
 */
#ifdef DOXYGEN_SHOULD_SKIP_THIS
