                                              ...
                                              uint32_t creditPaymentDate, uint8_t *creditPaymentRef)
{
  ...
  if ( creditPaymentRefLength != 0U ) {
    MEMCOPY(priceServerInfo.creditPaymentTable.creditPayment[ep][index].creditPaymentRef, creditPaymentRef, creditPaymentRefLength + 1);
  }
}
