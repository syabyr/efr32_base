 ...
 * ::emberSetSelectiveJoinPayload() API. When invoked at an ::EMBER_STAR_COORDINATOR or an
...
/** @brief The device starts operating as a frequency hopping server. This API can
