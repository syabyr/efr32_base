 ...
 *
 * @param[in] checkCca   If set to \b true, the node  performs a clear
 *                   channel assessment prior to transmit a packet. If the
 *                   channel is not clear, a random backoff is performed.
 *                   If this is set to \b false, no clear channel assessment is
 *                   performed and the packet is transmitted immediately.
 *                   This parameter is by default set to \b true.
 *
