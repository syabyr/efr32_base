 ...
 * (e.g. gcc -D) or you can add them to the file which is defined by
 * CONFIGURATION-HEADER. You can do both on the "Other" tab of the Application
 * Builder.
 *
 ...
 * Framework events. See @ref event for more details.
 * @warning This should be configured from the Stack Common plugin options.
 */
