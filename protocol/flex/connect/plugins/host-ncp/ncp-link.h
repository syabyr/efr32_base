 ...
 * @param[in] timeoutMs The timeout in miliseconds.
 ...
 * @param[in] managementType The type of management command being sent.
 * @param[in] data A pointer to the management command data.
 * @param[in] dataLength The length of the management command being sent.
 ...
 * @param[in] data A pointer to the data that was not sent.
 * @param[in] len The length of the data that was not sent in bytes.
 * @param[in] hostToNcp True if this message was from the host to VNCP in RTOS
 ...
 * @param[in] secured Whether this packet should be secured at the MAC layer.
 * @param[in] b A buffer containing the raw IPv6 packet.
 ...
 * NCP link.
 * @param[in] managementType The type of management command received.
 * @param[in] data A pointer to the data for this management packet.
 * @param[in] len The length of the management command to process.
 * @return true if we were able to process the packet and false if something
 * went wrong.
 */
