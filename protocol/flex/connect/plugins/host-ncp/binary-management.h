 ...
 *
 * @param[in] identifier The command identifier
 * (see app/tmsp/tmsp-enum.h for a list).
 *
 * @param[in] format The format string of the values starting in the third
 * argument. This string may contain any of the following values:
 *
 * u: one byte, uint8_t
 * s: one byte, int8_t
 ...
 *
 * @param[in] ... The actual values specified in format.
 */
