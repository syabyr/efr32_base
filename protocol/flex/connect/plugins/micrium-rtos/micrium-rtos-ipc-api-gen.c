...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_SET_INDIRECT_QUEUE_TIMEOUT_IPC_COMMAND_ID,
                                           "w",
                                           timeoutMs);
...
{
  uint32_t timeoutMs;
  emAfPluginMicriumRtosFetchApiParams("w",
                                      &timeoutMs);
  EmberStatus status = emApiSetIndirectQueueTimeout(timeoutMs);
  emAfPluginMicriumRtosSendResponse(EMBER_SET_INDIRECT_QUEUE_TIMEOUT_IPC_COMMAND_ID,
                                    "u",
                                    status);
}
...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_IPC_COMMAND_ID,
                                           "vb",
                                           shortId,
                                           longId, EUI64_SIZE);
...
static void macAddShortToLongAddressMappingCommandHandler(void)
{
  ...
  emAfPluginMicriumRtosFetchApiParams("vb",
                                      &shortId,
                                      &longId);
  EmberStatus status = emApiMacAddShortToLongAddressMapping(shortId,
                                                            longId);
  emAfPluginMicriumRtosSendResponse(EMBER_MAC_ADD_SHORT_TO_LONG_ADDRESS_MAPPING_IPC_COMMAND_ID,
                                    "u",
                                    status);
}
...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_IPC_COMMAND_ID,
                                           "");
...
static void macClearShortToLongAddressMappingsCommandHandler(void)
{
  ...
  emAfPluginMicriumRtosSendResponse(EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_IPC_COMMAND_ID,
                                    "u",
                                    status);
}
...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_NETWORK_LEAVE_IPC_COMMAND_ID,
                                           "");
...
static void networkLeaveCommandHandler(void)
{
  ...
  emAfPluginMicriumRtosSendResponse(EMBER_NETWORK_LEAVE_IPC_COMMAND_ID,
                                    "u",
                                    status);
}
...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_SET_ACTIVE_SCAN_DURATION_IPC_COMMAND_ID,
                                           "v",
                                           durationMs);
...
static void setActiveScanDurationCommandHandler(void)
{
  ...
  emAfPluginMicriumRtosSendResponse(EMBER_SET_ACTIVE_SCAN_DURATION_IPC_COMMAND_ID,
                                    "u",
                                    status);
}
...
{
  emAfPluginMicriumRtosAcquireCommandMutex();
  emAfPluginMicriumRtosSendBlockingCommand(EMBER_GET_ACTIVE_SCAN_DURATION_IPC_COMMAND_ID,
                                           "");
...
static void getActiveScanDurationCommandHandler(void)
{
  ...
  emAfPluginMicriumRtosSendResponse(EMBER_GET_ACTIVE_SCAN_DURATION_IPC_COMMAND_ID,
                                    "v",
                                    durationMs);
}
