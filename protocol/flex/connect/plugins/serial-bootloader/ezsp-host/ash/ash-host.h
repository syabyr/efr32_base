 ...
 *
 * @param[in] config  one of the following:
 ...
 *
 * @param[in] len    length of data field.
 *
 * @param[in] inptr  a pointer to array containing the data to be sent.
 *
 * @return
 * - ::EZSP_SUCCESS
 ...
 *
 * @param[in] init set true on the first call to this function, starts timer.
 *
 * @return
 ...
 *
 * @param[out] len     length of the DATA frame if one was returned.
 *
 * @param[out] buffer  array into which the DATA frame should be copied.
 *
 * @return
 * - ::EZSP_SUCCESS
 * - ::EZSP_ASH_NO_RX_DATA
