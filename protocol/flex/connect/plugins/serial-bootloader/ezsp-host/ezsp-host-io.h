 ...
 *
 * @param[out] byte A pointer to a variable where the byte read will be output.
 *
 * @return
 * - ::EZSP_SUCCESS
 * - ::EZSP_NO_RX_DATA
 ...
 *
 * @param[out] count A pointer to a variable where the byte count will be
 * written.
 *
 * @return
 * - ::EZSP_SUCCESS
