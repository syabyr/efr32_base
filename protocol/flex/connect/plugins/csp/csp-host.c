...
{
  emSendBinaryManagementBlockingCommand(EMBER_SET_INDIRECT_QUEUE_TIMEOUT_COMMAND_IDENTIFIER,
                                        "w",
                                        timeoutMs);
...
static void emberSetIndirectQueueTimeoutReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
{
  emSendBinaryManagementBlockingCommand(EMBER_NETWORK_LEAVE_COMMAND_IDENTIFIER,
                                        "");
...
static void emberNetworkLeaveReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
{
  emSendBinaryManagementBlockingCommand(EMBER_SET_ACTIVE_SCAN_DURATION_COMMAND_IDENTIFIER,
                                        "v",
                                        durationMs);
...
static void emberSetActiveScanDurationReturn(void)
{
  EmberStatus status;
  status = emberUnsignedCommandArgument(0);
...
{
  emSendBinaryManagementBlockingCommand(EMBER_GET_ACTIVE_SCAN_DURATION_COMMAND_IDENTIFIER,
                                        "");
...
static void emberGetActiveScanDurationReturn(void)
{
  uint16_t durationMs;
  durationMs = emberUnsignedCommandArgument(0);
...
const EmberCommandEntry managementCallbackCommandTable[] =
{
  ...
  emberBinaryCommandEntryAction(EMBER_GET_MAXIMUM_PAYLOAD_LENGTH_RETURN_IDENTIFIER,
                                ...
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_SET_INDIRECT_QUEUE_TIMEOUT_RETURN_IDENTIFIER,
                                emberSetIndirectQueueTimeoutReturn,
                                "u",
                                NULL),
  ...
  emberBinaryCommandEntryAction(EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_RETURN_IDENTIFIER,
                                ...
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_NETWORK_LEAVE_RETURN_IDENTIFIER,
                                emberNetworkLeaveReturn,
                                "u",
                                NULL),
  ...
  emberBinaryCommandEntryAction(EMBER_GET_AUXILIARY_ADDRESS_FILTERING_ENTRY_RETURN_IDENTIFIER,
                                ...
                                "v",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_SET_ACTIVE_SCAN_DURATION_RETURN_IDENTIFIER,
                                emberSetActiveScanDurationReturn,
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_GET_ACTIVE_SCAN_DURATION_RETURN_IDENTIFIER,
                                emberGetActiveScanDurationReturn,
                                "v",
                                NULL),
