...
static void ncpSetIndirectQueueTimeoutCommand(void)
{
  uint32_t timeoutMs;
  timeoutMs = (uint32_t) emberUnsignedCommandArgument(0);
  EmberStatus status = emberSetIndirectQueueTimeout(timeoutMs);
  emSendBinaryManagementCommand(EMBER_SET_INDIRECT_QUEUE_TIMEOUT_RETURN_IDENTIFIER,
                                "u",
                                status);
}
...
// networkLeave
static void ncpNetworkLeaveCommand(void)
{
  EmberStatus status = emberNetworkLeave();
  emSendBinaryManagementCommand(EMBER_NETWORK_LEAVE_RETURN_IDENTIFIER,
                                "u",
                                status);
}
...
static void ncpSetActiveScanDurationCommand(void)
{
  uint16_t durationMs;
  durationMs = (uint16_t) emberUnsignedCommandArgument(0);
  EmberStatus status = emberSetActiveScanDuration(durationMs);
  emSendBinaryManagementCommand(EMBER_SET_ACTIVE_SCAN_DURATION_RETURN_IDENTIFIER,
                                "u",
                                status);
}

// getActiveScanDuration
static void ncpGetActiveScanDurationCommand(void)
{
  uint16_t durationMs = emberGetActiveScanDuration();
  emSendBinaryManagementCommand(EMBER_GET_ACTIVE_SCAN_DURATION_RETURN_IDENTIFIER,
                                "v",
                                durationMs);
}
...
const EmberCommandEntry emberCommandTable[] =
{
  ...
  emberBinaryCommandEntryAction(EMBER_GET_MAXIMUM_PAYLOAD_LENGTH_COMMAND_IDENTIFIER,
                                ...
                                "uuuu",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_SET_INDIRECT_QUEUE_TIMEOUT_COMMAND_IDENTIFIER,
                                ncpSetIndirectQueueTimeoutCommand,
                                "w",
                                NULL),
  ...
  emberBinaryCommandEntryAction(EMBER_MAC_CLEAR_SHORT_TO_LONG_ADDRESS_MAPPINGS_COMMAND_IDENTIFIER,
                                ...
                                "",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_NETWORK_LEAVE_COMMAND_IDENTIFIER,
                                ncpNetworkLeaveCommand,
                                "",
                                NULL),
  ...
  emberBinaryCommandEntryAction(EMBER_GET_AUXILIARY_ADDRESS_FILTERING_ENTRY_COMMAND_IDENTIFIER,
                                ...
                                "u",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_SET_ACTIVE_SCAN_DURATION_COMMAND_IDENTIFIER,
                                ncpSetActiveScanDurationCommand,
                                "v",
                                NULL),
  emberBinaryCommandEntryAction(EMBER_GET_ACTIVE_SCAN_DURATION_COMMAND_IDENTIFIER,
                                ncpGetActiveScanDurationCommand,
                                "",
                                NULL),
